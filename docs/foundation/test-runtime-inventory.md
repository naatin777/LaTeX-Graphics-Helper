...
| `test/convert_to_pdf_operation.test.ts`, `test/png_safe_mode.test.ts`                                                                                                                                           | Sharp/native conversion and transaction safety                  | verify ABI, fixture path, timeout and failure injection on 3 OS                       |
