...
- [0203: dev test toolingのserialize-javascript vulnerabilityを更新する](0203-update-dev-test-tooling-serialize-javascript.md) - `@vscode/test-cli`/`mocha`経由のhigh advisory。fix提供またはbreaking評価後に着手する条件付きtask。
