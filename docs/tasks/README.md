...
- [0180: パッケージ済みVSIXのオフライン3 OS smoke testを追加する](0180-add-packaged-vsix-offline-smoke-tests.md) - cleanなbaseからのPRで、lockfile準拠のpackage、実際のCLI失敗経路、Webview offline範囲を再確認する。
