...
| `pnpm run test`                                                      | Pass   | 224 Extension Host tests passed, including common Puppeteer executable path, Mermaid channel precedence, legacy fallback, and TypeScript scanner-based `userMessage` argument counting. |
