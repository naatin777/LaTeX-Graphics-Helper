...
- `docs/specs/product/v1-migration-from-v051.md`を追加した
...
- 既存の`docs/specs/internal/output-format-conversion.md`と`docs/adr/0009-use-output-format-conversion-commands.md`に残っていた「aliasを残してよい」方針を、v1.0.0向けの決定と矛盾しない形へ更新した
