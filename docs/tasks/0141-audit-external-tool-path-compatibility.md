...
- Windowsではnative separatorとforward slashで結果に差がなかった
- pdfcropはCI runnerにTeX環境がなく未実行、手元macOSでは全caseが成功した
- 詳細を[外部コマンドのOS別path互換性調査](../research/2026-07-11-external-tool-path-compatibility.md)へ記録した
- 問題が確認された3 toolをタスク0143から0148へ分割した
