# タスク: cropPdf.manual GUIの失敗テストを追加する
...
`cropPdf.manual` の実装前に、Webview表示、Hostとのmessage連携、出力反映の主要な振る舞いを失敗テストとして固定する。
...
- `docs/tasks/0104-add-crop-pdf-manual-gui-tests.md`
