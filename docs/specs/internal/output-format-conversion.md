...
Webviewを使用しない出力形式基準コマンドは、`docs/specs/internal/conversion-progress-and-cancellation.md`に従う。
...
出力反映は`docs/specs/internal/safe-mode.md`に従う。
...
既存変換と同じ扱いにする。このspecの`Progress / Cancellation / Safe Mode / Undo`および`docs/specs/internal/safe-mode.md`に従う。
