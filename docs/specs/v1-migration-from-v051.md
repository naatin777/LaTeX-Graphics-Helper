...
- Mermaid → PDF: `latex-graphics-helper.convertToPdf.mermaid.puppeteer.executablePath`
- Mermaid → SVG: `latex-graphics-helper.convertToSvg.mermaid.puppeteer.executablePath`

理由:

- Puppeteer利用箇所ごとに必要な設定が異なる
...
- Mermaid → PDF: `latex-graphics-helper.convertToPdf.mermaid.puppeteer.browserChannel`
- Mermaid → SVG: `latex-graphics-helper.convertToSvg.mermaid.puppeteer.browserChannel`

理由:

- `execPath.puppeteer`と同じく、Puppeteer利用箇所ごとに設定を分ける
- 変換処理ごとの検証範囲を明確にする
