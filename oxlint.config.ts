...
const coreForbiddenPaths = [
  {
    name: 'vscode',
    message: 'Keep VS Code API out of core/application/operation code. Convert VS Code objects in commands first.',
  },
...
const webviewFrontendForbiddenPaths = [
  {
    name: 'vscode',
    message: 'Webview frontend cannot import the VS Code extension API. Use acquireVsCodeApi wrapper instead.',
  },
  {
    name: 'fs',
            ...
            patterns: [
              {
                ...
                message: 'Core code must not depend on command/UI code. Pass plain data from commands instead.',
              },
              {
          ...
          'error',
          {
            ...
            patterns: [
              ...
              },
              {
                ...
                message: 'pdf-workbench must not import pdf-arranger directly. Move shared code to webview/shared.',
              },
            ],
          },
        ],
          ...
          'error',
          {
            ...
            patterns: [
              ...
              },
              {
                ...
                message: 'pdf-arranger must not import pdf-workbench directly. Move shared code to webview/shared.',
              },
            ],
          },
        ],
