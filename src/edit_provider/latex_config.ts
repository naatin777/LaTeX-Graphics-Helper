...
export function readLatexInsertionConfig(): LatexInsertionConfig {
  ...
  return {
    outputPathClipboardImage: configuration.get<string>(
    ...
    figureGraphicsOptions: configuration.get<string[]>("figure.graphicsOptions", [
      "[width=1.0\\linewidth]",
    ]),
    subfigureVerticalAlignmentOptions: configuration.get<string[]>(
      "subfigure.verticalAlignmentOptions",
      ["[t]"],
    ),
    subfigureWidthOptions: configuration.get<string[]>("subfigure.widthOptions", [
      "{0.45\\linewidth}",
    ]),
    subfigureSpacingOptions: configuration.get<string[]>("subfigure.spacingOptions", [
