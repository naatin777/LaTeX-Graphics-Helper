...
| Convert to PDF         | `.png`, `.jpg`, `.jpeg`, `.webp`, `.avif`, `.gif`, `.tif`, `.tiff`, `.eps`                                           | `.pdf`                  | Convert raster/EPS images to PDF           | Ghostscript for EPS                                              |
...
| Convert to PNG         | `.pdf`, `.jpg`, `.jpeg`, `.webp`, `.avif`, `.gif`, `.tif`, `.tiff`, `.eps`, `.svg`, Mermaid, editable Draw.io images | `.png`                  | Convert figure files to PNG                | Poppler for PDF/EPS input                                        |
| Convert to JPEG        | `.pdf`, `.png`, `.webp`, `.avif`, `.gif`, `.tif`, `.tiff`, `.eps`, `.svg`, Mermaid, editable Draw.io images          | `.jpeg`                 | Convert figure files to JPEG               | Poppler for PDF/EPS input                                        |
| Convert to WebP        | `.pdf`, `.png`, `.jpg`, `.jpeg`, `.avif`, `.gif`, `.tif`, `.tiff`, `.eps`, `.svg`, Mermaid, editable Draw.io images  | `.webp`                 | Convert figure files to WebP               | Poppler for PDF/EPS input                                        |
| Convert to AVIF        | `.pdf`, `.png`, `.jpg`, `.jpeg`, `.webp`, `.gif`, `.tif`, `.tiff`, `.eps`, `.svg`, Mermaid, editable Draw.io images  | `.avif`                 | Convert figure files to AVIF               | Poppler for PDF/EPS input                                        |
...
GIF/TIFF input uses only the first page/frame. EPS input requires Ghostscript and is converted through a staged PDF.
...
- **Ghostscript**: Required for PDF margin detection during PDF cropping and EPS input conversion.
